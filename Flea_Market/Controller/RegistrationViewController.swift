...
//        NetworkingManager.shard.postNetworking()
    ...
    private func configureUI() {
        ...
        registrationLabel.topAnchor.constraint(equalTo: view.topAnchor, constant: 60).isActive = true
        
        view.addSubview(idLabel)
        idLabel.translatesAutoresizingMaskIntoConstraints = false
        idLabel.topAnchor.constraint(equalTo: registrationLabel.bottomAnchor, constant: 60).isActive = true
        idLabel.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 40).isActive = true
        
        view.addSubview(idTextField)
        idTextField.translatesAutoresizingMaskIntoConstraints = false
        idTextField.topAnchor.constraint(equalTo: registrationLabel.bottomAnchor, constant: 60).isActive = true
