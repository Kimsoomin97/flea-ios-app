...
//        NetworkingManager.shard.postNetworking()
    ...
    private func configureUI() {
        ...
        idLabel.topAnchor.constraint(equalTo: myPageViewLabel.topAnchor, constant: 80).isActive = true
//        idLabel.topAnchor.constraint(equalTo: myPageViewLabel.bottomAnchor, constant: -160).isActive = true
        ...
        idViewLabel.topAnchor.constraint(equalTo: myPageViewLabel.topAnchor, constant: 80).isActive = true
        ...
        pwLabel.topAnchor.constraint(equalTo: idLabel.topAnchor, constant: 50).isActive = true
        pwLabel.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 40).isActive = true
        
        view.addSubview(pwTextField)
        pwTextField.translatesAutoresizingMaskIntoConstraints = false
        pwTextField.topAnchor.constraint(equalTo: idViewLabel.topAnchor, constant: 50).isActive = true
        ...
        confiPWTextField.topAnchor.constraint(equalTo: pwTextField.topAnchor, constant: 20).isActive = true
        confiPWTextField.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 150).isActive = true
        
        view.addSubview(emailLabel)
        emailLabel.translatesAutoresizingMaskIntoConstraints = false
        emailLabel.topAnchor.constraint(equalTo: confiPWTextField.topAnchor, constant: 40).isActive = true
        emailLabel.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 40).isActive = true
        
        view.addSubview(emailTextField)
        emailTextField.translatesAutoresizingMaskIntoConstraints = false
        emailTextField.topAnchor.constraint(equalTo: confiPWTextField.topAnchor, constant: 30).isActive = true
        emailTextField.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 150).isActive = true
        
        view.addSubview(phoneLabel)
        phoneLabel.translatesAutoresizingMaskIntoConstraints = false
        phoneLabel.topAnchor.constraint(equalTo: emailLabel.topAnchor, constant: 30).isActive = true
        phoneLabel.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 40).isActive = true
        
        view.addSubview(phoneTextField)
        phoneTextField.translatesAutoresizingMaskIntoConstraints = false
        phoneTextField.topAnchor.constraint(equalTo: emailTextField.topAnchor, constant: 30).isActive = true
        phoneTextField.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 150).isActive = true
        
        view.addSubview(nicknameLabel)
        nicknameLabel.translatesAutoresizingMaskIntoConstraints = false
        nicknameLabel.topAnchor.constraint(equalTo: phoneLabel.topAnchor, constant: 30).isActive = true
        nicknameLabel.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 40).isActive = true
        
        view.addSubview(nicknameTextField)
        nicknameTextField.translatesAutoresizingMaskIntoConstraints = false
        nicknameTextField.topAnchor.constraint(equalTo: phoneTextField.topAnchor, constant: 30).isActive = true
        nicknameTextField.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 150).isActive = true
        
        view.addSubview(addressLabel)
        addressLabel.translatesAutoresizingMaskIntoConstraints = false
        addressLabel.topAnchor.constraint(equalTo: nicknameLabel.topAnchor, constant: 30).isActive = true
        addressLabel.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 40).isActive = true
        
        view.addSubview(addressTextField)
        addressTextField.translatesAutoresizingMaskIntoConstraints = false
        addressTextField.topAnchor.constraint(equalTo: nicknameTextField.topAnchor, constant: 30).isActive = true
