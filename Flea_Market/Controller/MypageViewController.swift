...
//        NetworkingManager.shard.postNetworking()
    ...
    private func configureUI() {
        ...
        MypageLabel.centerXAnchor.constraint(equalTo: view.safeAreaLayoutGuide.centerXAnchor).isActive = true
        MypageLabel.topAnchor.constraint(equalTo: view.topAnchor, constant: 60).isActive = true
        
        view.addSubview(idLabel)
        idLabel.translatesAutoresizingMaskIntoConstraints = false
        idLabel.topAnchor.constraint(equalTo: MypageLabel.bottomAnchor, constant: 60).isActive = true
        ...
        idViewLabel.topAnchor.constraint(equalTo: MypageLabel.bottomAnchor, constant: 60).isActive = true
